        ...
        this.tl = gsap.timeline({
            scrollTrigger: {
                ...
                onUpdate: (self) => {
                    ...
                    this.experience.camera.instance.position.y = point.y - 7;
                    this.experience.camera.controls.target.y = point.y - 7;
                    this.model.position.copy(point);
                    if(self.direction == -1){
                        tangent.negate();
                    }
